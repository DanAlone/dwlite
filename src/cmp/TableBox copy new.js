...
//import '../node_modules/datatables.net/css/dataTables.semanticui.min.css';
//import '../node_modules/datatables.net/css/responsive.semanticui.min.css';
...
//import '../node_modules/datatables.net-autofill/js/dataTables.autoFill.min.js';
//import '../node_modules/datatables.net-select/js/dataTables.select.min.js';
// DATATABLE BUTTONS
...
//import pdfMake from '../node_modules/datatables.net/pdfmake/build/pdfmake';
//import pdfMake from 'pdfmake';
import vfs_fonts from '../node_modules/datatables.net/pdfmake/build/vfs_fonts';
...
function TableBox({ handleSetUpdating, handleUnsetUpdating, handleSetLabelProgress, handleUpdated, handleStopUpdateAll, UpdateAll, updating, boxtable, ACTION, inverted, invertedStyle, onLoading, handleError, Refresh, status_filter, CountStatus, handleInitArray, handleRotate, getBox }) {
    ...
    //const buttons = require( 'datatables.net-buttons-dt' );
